...
cm = Cat_and_Mouse(rows=1, columns=7, mouseInitLoc=[0, 3], cheeseLocs=[[0, 0], [0, 6]], stickyLocs=[[0, 2]],
                   slipperyLocs=[[0, 4]])
...
print('New state: {} Reward: {} GameOver: {}'.format(newState, reward,
                                                     gameOver))  # ah ha! we got a reward this time, found the cheese, gameOver!
