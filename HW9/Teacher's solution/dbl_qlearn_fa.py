...
def dbl_qlearn_fa(simenv, q1, q2, gamma, epsilon, alpha, num_episodes, max_episode_len,
                  window_len=100, term_thresh=None, epsilon_decay_len=None, decayEpsilon=True, showPlots=False,
                  prng_seed=789):
    '''
    Parameters:
        ...
        while episode_length < max_episode_len:
            ...
            with torch.no_grad():
                if term_status:
                    ...
                    q_s1_max = qfx.forward(next_state)[torch.argmax(
                        qup.forward(next_state))]  # don't include q_s1 in gradient, this is a semi-gradient method!
