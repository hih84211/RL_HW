...
data_train, data_test, target_train, target_test = train_test_split(ss_iris_subset, target_subset, test_size=0.15,
                                                                    random_state=11, stratify=target_subset)
...
#
weight = (0.25 * torch.randn(size=(2, 1), dtype=torch.float32)).clone().detach().requires_grad_(True)
